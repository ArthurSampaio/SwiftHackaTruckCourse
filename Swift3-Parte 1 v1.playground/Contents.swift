...
var swiftVersions : [String:Any] = ["Swift 1": 2014, "Swift 2":2015, "Swift 3":2016]
...
class MotorDeCarro: Gasolina {
    ...
    internal var quantidadeDeCombustível: Int
    
    internal func injetarCombustívelComAr() {
        print("injetou")
    }

    internal func ativarVela() {
        print("ligou")
    }
    
    init(quantidadeDeCombustível: Int){
        self.quantidadeDeCombustível = quantidadeDeCombustível
    }
...
class MotorDeCaminhão: Diesel {
    internal func injetarCombustívelSobPressão() {
        print("pressionado")
    }

    internal func injetarArAquecido() {
        print("ligou")
    }

    internal var quantidadeDeCombustível: Int
    
    init(quantidadeDeCombustivel: Int) {
        self.quantidadeDeCombustível = quantidadeDeCombustivel
    }
